...
const previousCompactLaptop = '@media(min-width:901px) and (max-height:850px){body{padding:10px}.page{gap:8px;min-height:calc(100svh - 20px)}.card{width:min(100%,720px);max-width:720px;padding:24px 28px;border-radius:18px}.tag{font-size:10px;padding:5px 12px;margin-bottom:10px}.card-title{font-size:28px;margin-bottom:7px}.card-sub{font-size:14px;margin-bottom:14px;line-height:1.45}.label{font-size:10px;margin-bottom:8px}.radio-group{gap:8px;margin-bottom:16px}.radio label{min-height:48px;padding:9px 12px;font-size:13px}.actions{gap:10px}.btn{height:50px;font-size:15px}.back-icon{width:22px;height:22px;flex-basis:22px;font-size:14px}.footer{font-size:11px;padding:3px 0}}';
const compactLaptop = '@media(min-width:901px) and (max-width:1600px), (min-width:901px) and (max-height:900px){body{padding:10px}.page{gap:8px;min-height:calc(100svh - 20px)}.card{width:min(100%,620px);max-width:620px;padding:22px 24px;border-radius:18px}.tag{font-size:10px;padding:5px 12px;margin-bottom:10px}.card-title{font-size:26px;margin-bottom:7px}.card-sub{font-size:14px;margin-bottom:14px;line-height:1.45}.label{font-size:10px;margin-bottom:8px}.radio-group{gap:8px;margin-bottom:16px}.radio label{min-height:46px;padding:8px 10px;font-size:13px}.actions{gap:10px}.btn{height:48px;font-size:14px}.back-icon{width:22px;height:22px;flex-basis:22px;font-size:14px}.footer{font-size:11px;padding:3px 0}}';
...
for (const file of files) {
  ...
  for (const node of workflow.nodes || []) {
    ...
    if (code.includes(oversizedDesktop)) {
      ...
      patched += 1;
    } else if (code.includes(previousCompactLaptop)) {
      code = code.replace(previousCompactLaptop, compactLaptop);
      patched += 1;
